...
var dbConf = {
  host      : process.env.ELIPSIS_DB_HOST || fileConf.database.host,
  port      : process.env.ELIPSIS_DB_PORT || fileConf.database.port,
  name      : process.env.ELIPSIS_DB_NAME || fileConf.database.name,
  user      : process.env.ELIPSIS_DB_USER || fileConf.database.user,
  password  : process.env.ELIPSIS_DB_PWD  || fileConf.database.password
}
