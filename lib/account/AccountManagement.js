      ...
      if(err) {
        ...
        if(newAccount) {
          ...
          Notification.send(email, 'Connexion notification',
            'Hi,\n\n' +
              'This automated message is just to let you know that someone successfully logged-in into your account [' + email + '] at https://elipsis.io/\n\n' +
              'The IP address used for the connection was [' + ipAddress + ']\n\n' +
              '- Nicolas Herment\n' +
              'https://elipsis.io/')
        }
